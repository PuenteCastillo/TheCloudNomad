...
export default function Chromesoft_Two() {
  useEffect(() => {
    ...
    chromesoft_Tl
      ...
      .add("start", 0)
      .add("part2", 0)
      .from(".crmt_chrom_logo", 1, { opacity: 0 }, "start")
      .from(".crmt_box1", 1, { y: 50, opacity: 0 }, "start")
      .from(".crmt_tag", 1, { opacity: 0, delay: 1.5 }, "part2")
      .from(".crmt_cta", 1, { opacity: 0, delay: 2 }, "part2");

    chromesoft_Tl.seek(10);
    // start animtaion on hover jquery code
    // on mouse in

    $(".chromsoftBannerTwo").mouseenter(function () {
      // restart animation
    ...
    $(".chromsoftBannerTwo").mouseleave(function () {
      chromesoft_Tl.timeScale(5);
    });
  }, []);
  return (
    <>
      <div className="box chromsoftBannerTwo" id="ad">
        <div className="hide" id="content">
          <Image className="crmt_bg" src={BG} alt="" />
          <Image className="crmt_tag" src={TagLine} />
          <Image className="crmt_box1" src={Box1} alt="" />
          <Image className="crmt_chrom_logo" src={ChromLogo} />
          <Image className="crmt_cta" src={Cta} />
        </div>
      </div>
    </>
  );
